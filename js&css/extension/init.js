...
document.addEventListener("it-message-from-youtube", function () {
    ...
    if (provider) {
        ...
        document.dispatchEvent(
            new CustomEvent("it-message-from-youtube--readed"),
        );
            ...
            switch (message.type) {
                case "channel":
                    if (
                        ...
                        typeof extension.storage.data.blocklist.channels !==
                            "object"
                    ) {
                        extension.storage.data.blocklist.channels = {};
                    }
                    if (message.added) {
                        ...
                        delete extension.storage.data.blocklist
                            .channels[message.id];
                    }
                    break;
                ...
                case "video":
                    if (
                        ...
                        typeof extension.storage.data.blocklist.videos !==
                            "object"
                    ) {
                        extension.storage.data.blocklist.videos = {};
                    }
