...
ImprovedTube.myColors = function () {
  if (
    ...
    document.documentElement.hasAttribute("dark") !== null &&
    ...
    if (document.querySelector("ytd-masthead") !== null) {
      document.querySelector("ytd-masthead").style.backgroundColor =
        "" + primary_color + "";
    }
...
ImprovedTube.setTheme = function () {
  if (this.storage.theme === "default") {
    if (
      document.documentElement.hasAttribute("it-themes") !== null &&
      document.documentElement.hasAttribute("it-themes") === true
    ) {
      document.documentElement.removeAttribute("it-themes");
      // document.documentElement.setAttribute('it-themes', 'false');

      // set the default theme -> Dark theme start
      ...
      // set the default theme -> Dark theme end
    }
    ...
    this.storage.theme === "dawn" ||
    this.storage.theme === "sunset" ||
    this.storage.theme === "night"
  ) {
