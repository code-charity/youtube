...
------------------------------------------------------------------------------*/
ImprovedTube.selectDubbedLanguage = function (skipAutoGenerated) {
	const self = this;
	...
	var interval = setInterval(function () {
		...
		const targetTrack = tracks.find(function (track) {
			...
			// When skipAutoGenerated is true, only match exact language codes
			// (real dubs). Auto-generated dubs have numeric suffixes like 'en.1'
