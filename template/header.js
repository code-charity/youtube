        ...
        section_end: {
            ...
            vert: {
                ...
                onclick: function(event) {
                    ...
                    if (document.querySelector('.satus').dataset.path === 'main/shortcuts') {
                        document.querySelector('.satus').appendChild(Satus.components.dialog({
                            ...
                            reset_all_shortcuts: {
                                ...
                                onclick: function() {
                                    ...
                                    document.querySelector('.satus').appendChild(Satus.components.dialog({
                                        ...
                                        message: {
                                            type: 'text',
                                            label: 'thisWillResetAllShortcuts',
                                            style: {
                                                'width': '100%',
                                                'opacity': '.8'
                                            }
                                        ...
                                        section: {
                                            ...
                                            ok: {
                                                ...
                                                onclick: function() {
                                                    ...
                                                    var data = Satus.storage.get('');

                                                    for (var key in data) {
                                                        if (key.indexOf('shortcut_') !== -1) {
                                                            Satus.storage.set(key, null);
                                                        }
                                                    }
                                                }
                                            }
