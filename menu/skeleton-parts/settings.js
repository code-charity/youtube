      ...
      click: {
        section: {
          ...
          languages: [
            ...
            {
              value: "nb-NO",
              text: "Norwegian Bokmål (not yet selectable on YouTube)",
            },
            ...
            {
              value: "fa-IR",
              text: "Iranian Persian (not yet selectable on YouTube)",
            },
          ...
          improvedtube: {
            ...
            storage: "language",
            options: function () {
              return extension.skeleton.header.sectionEnd.menu.on.click.settings
                .on.click.secondSection.language.on.click.section.languages;
            },
          },
          youtube: {
            component: "select",
            ...
            options: function () {
              return [{ value: "disabled", text: "Disabled" }].concat(
                extension.skeleton.header.sectionEnd.menu.on.click.settings.on
                  .click.secondSection.language.on.click.section.languages
              );
            },
            on: {
              ...
              click: function () {
                if (
                  location.href.indexOf(
                    "/index.html?action=import-settings"
                  ) !== -1
                ) {
                  ...
                  window.open(
                    chrome.runtime.getURL(
                      "menu/index.html?action=import-settings"
                    ),
                    "_blank"
                  );
                }
          ...
          exportSettings: {
            ...
            on: {
              click: function () {
                if (
                  location.href.indexOf(
                    "/index.html?action=export-settings"
                  ) !== -1
                ) {
                  ...
                  window.open(
                    chrome.runtime.getURL(
                      "menu/index.html?action=export-settings"
                    ),
                    "_blank"
                  );
                }
        ...
        extensionSection: {
          ...
          list: {
            ...
            items: [
              ...
              [
                "version",
                satus.user.browser.manifest().version_name ||
                  satus.user.browser.manifest().version,
              ],
              [
                "permissions",
                satus.user.browser
                  .manifest()
                  .permissions.join(", ")
                  .replace("https://www.youtube.com/", "YouTube"),
              ],
            ],
          },
        },
