  ...
  layers: {
    ...
    on: {
      open: function () {
        ...
        var vertical_menu = document.querySelector(
          ".satus-modal--vertical-menu"
        );
    ...
    frame: {
      ...
      attr: {
        ...
        style:
          "border: none; bottom: 0px; overflow: hidden; width:326px; position: absolute; height:212px; left:-6px !important",
      },
    },
  },
};
