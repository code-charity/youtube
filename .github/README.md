...
![CI Status](https://github.com/code-charity/youtube/actions/workflows/eslint_csslint_jest.yml/badge.svg)
...
- **Chrome / Chromium / Brave / Edge / Vivaldi**
  - 2.) Go to your Browser's Extensions page (_chrome://extensions/_)
  - 3.) Activate `Developer mode`
  - 4.) Click the `Load unpacked` button & Select the extracted folder

- **Firefox / LibreWolf / Waterfox / IceCat**
  - 2.) Go to `Add-ons` (_about:addons_)
  - 3.) Click on `Extensions` tab
  - 4.) Click on `Debug Add-ons` (_about:debugging#/runtime/this-firefox_)
