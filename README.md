...
-  [ ]  [**active Bugs**](https://github.com/ImprovedTube/YouTube/issues?q=label%3Abug+sort%3Acomments-desc+is%3Aopen) *(maybe we can offer a small bounty (payment/compensation) on solving Issues labeled "priority". Please ask)*
