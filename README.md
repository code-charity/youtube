...
* [English](https://github.com/ImprovedTube/ImprovedTube/blob/master/_locales/en/messages.json) by __ (and all [contributors](https://github.com/ImprovedTube/ImprovedTube/graphs/contributors))
