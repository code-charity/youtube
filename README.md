...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  is an extension we built to refine and sweeten your YouTube experience. A one-stop-shop with many powerful features to enhance YouTube, yet liteweight. A larger player, tidy UI and hidinig distractions were the first loved features. Simply to save time. But that is not all…! There was (and is) so much left to build. ImprovedTube's is designed with our own UI library **[Satus](https://github.com/victor-savinov/satus)** to manage your settings efficiently and to create more powerful and familiar apps. (_BTW, technically, ImprovedTube is the only project in the world providing so much CSS to adjust another site🦄 (_[cmiiw](https://github.com/search?q=stars%3A%3E700++size%3A%3E3000+++language%3ACSS++App+OR+Addon+OR+Extension+NOT+framework+NOT+apps&type=Repositories&s=updated&o=desc)_)</font>.
