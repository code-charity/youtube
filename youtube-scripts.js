...
ImprovedTube.ytElementsHandler = function (node) {
    ...
    if (name === 'A' && node.href) {
        ...
        if (document.documentElement.dataset.pageType === 'video' &&  id === 'expand-sizer' || id === 'more' && node.parentNode.parentNode.id === 'container') {
            setTimeout(function () {
...
/*------------------------------------------------------------------------------
4.2.3.4 HIDE DETAIL BUTTON     dislike: M17,4h-1H6.57C5.5,4,4.59,4.67,4.38,5.61l-1.34,
------------------------------------------------------------------------------*/
